...
public class SistemaPessoaCadastroUsuário extends JFrame {

    public SistemaPessoaCadastroUsuário() {
    ...
    public static void main(String[] args) {
        new SistemaPessoaCadastroUsuário();
    }
}
